...
public class LootTableGenerator extends BaseLootTableProvider
{
    ...
    protected void addTables()
    {
        ...
        lootTables.put(BlockRegistry.COPPER_ORE.get(), createSimpleTable("copper_ore", BlockRegistry.ALUMINIUM_ORE.get()));
        lootTables.put(BlockRegistry.IRIDIUM_ORE.get(), createSimpleTable("iridium_ore", BlockRegistry.ALUMINIUM_ORE.get()));
        lootTables.put(BlockRegistry.LEAD_ORE.get(), createSimpleTable("lead_ore", BlockRegistry.ALUMINIUM_ORE.get()));
        lootTables.put(BlockRegistry.NICKEL_ORE.get(), createSimpleTable("nickel_ore", BlockRegistry.ALUMINIUM_ORE.get()));
        lootTables.put(BlockRegistry.PLATINUM_ORE.get(), createSimpleTable("platinum_ore", BlockRegistry.ALUMINIUM_ORE.get()));
        lootTables.put(BlockRegistry.SILVER_ORE.get(), createSimpleTable("silver_ore", BlockRegistry.ALUMINIUM_ORE.get()));
        lootTables.put(BlockRegistry.TIN_ORE.get(), createSimpleTable("tin_ore", BlockRegistry.ALUMINIUM_ORE.get()));
        lootTables.put(BlockRegistry.URANIUM_ORE.get(), createSimpleTable("uranium_ore", BlockRegistry.ALUMINIUM_ORE.get()));
