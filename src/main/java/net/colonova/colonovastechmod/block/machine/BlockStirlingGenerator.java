...
public class BlockStirlingGenerator extends BlockBase
{
    public BlockStirlingGenerator(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
