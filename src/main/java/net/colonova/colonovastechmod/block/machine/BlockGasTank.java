...
public class BlockGasTank extends BlockBase implements IMachineBlock
{
    private final int tankCapacity;
    private final MachineType machineType;

    public BlockGasTank(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType, int tankCapacity)
    {
