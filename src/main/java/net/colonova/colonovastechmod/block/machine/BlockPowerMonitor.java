...
public class BlockPowerMonitor extends BlockBase
{
    public BlockPowerMonitor(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
