...
public class BlockCrafter extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockCrafter(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
