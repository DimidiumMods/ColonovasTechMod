...
public class BlockNetherStarGenerator extends BlockBase
{
    public BlockNetherStarGenerator(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
