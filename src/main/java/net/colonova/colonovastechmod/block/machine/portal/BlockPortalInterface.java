...
public class BlockPortalInterface extends BlockBase implements IMachineBlock
{
    private final MachineType machineType;

    public BlockPortalInterface(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
