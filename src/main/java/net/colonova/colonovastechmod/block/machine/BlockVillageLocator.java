...
public class BlockVillageLocator extends BlockBase
{
    public BlockVillageLocator(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
