...
public class BlockTimeController extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockTimeController(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
