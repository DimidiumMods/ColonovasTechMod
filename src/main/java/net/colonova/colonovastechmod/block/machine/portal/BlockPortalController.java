...
public class BlockPortalController extends BlockBase implements IMachineBlock
{
    private final MachineType machineType;

    public BlockPortalController(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
