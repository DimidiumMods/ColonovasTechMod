...
public class BlockUncrafter extends BlockBase
{
    public BlockUncrafter(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
