...
public class BlockEnderGenerator extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockEnderGenerator(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
