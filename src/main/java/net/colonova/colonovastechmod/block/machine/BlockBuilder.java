...
public class BlockBuilder extends BlockBase //implements EntityBlock, IMachineBlock
{
    private final MachineType machineType;

    public BlockBuilder(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
