...
public class BlockQuarryFortuneUpgrade extends BlockBase
{
    public BlockQuarryFortuneUpgrade(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
