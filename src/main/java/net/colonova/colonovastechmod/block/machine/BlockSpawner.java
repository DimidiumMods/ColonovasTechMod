...
public class BlockSpawner extends BlockBase
{
    public BlockSpawner(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
