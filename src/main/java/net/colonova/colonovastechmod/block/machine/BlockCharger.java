...
public class BlockCharger extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockCharger(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
