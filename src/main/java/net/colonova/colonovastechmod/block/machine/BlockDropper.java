...
public class BlockDropper extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockDropper(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
