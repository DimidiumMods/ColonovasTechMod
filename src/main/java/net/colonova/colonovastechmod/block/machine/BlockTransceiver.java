...
public class BlockTransceiver extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockTransceiver(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
