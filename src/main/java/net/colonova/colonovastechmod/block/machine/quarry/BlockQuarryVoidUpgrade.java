...
public class BlockQuarryVoidUpgrade extends BlockBase
{
    public BlockQuarryVoidUpgrade(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
