...
public class BlockWither extends BlockBase
{
    public BlockWither(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
