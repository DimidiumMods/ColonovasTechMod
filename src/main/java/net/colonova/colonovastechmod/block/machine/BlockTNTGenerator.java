...
public class BlockTNTGenerator extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockTNTGenerator(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
