...
public class BlockEnchanter extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockEnchanter(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
