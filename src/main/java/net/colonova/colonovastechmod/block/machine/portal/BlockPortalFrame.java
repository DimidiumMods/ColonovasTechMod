...
public class BlockPortalFrame extends BlockBase implements IMachineBlock
{
    private final MachineType machineType;

    public BlockPortalFrame(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
