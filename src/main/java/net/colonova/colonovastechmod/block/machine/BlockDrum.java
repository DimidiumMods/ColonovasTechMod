...
public class BlockDrum extends BlockBase //implements EntityBlock, IMachineBlock
{

    public BlockDrum(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
