...
public class BlockPainter extends BlockBase
{
    public BlockPainter(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
