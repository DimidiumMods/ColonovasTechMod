...
public class BlockLavaGenerator extends BlockBase
{
    public BlockLavaGenerator(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
