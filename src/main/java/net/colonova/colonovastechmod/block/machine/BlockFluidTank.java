...
public class BlockFluidTank extends BlockBase implements IMachineBlock //implements EntityBlock //, IMachineBlock
{
    private final int tankCapacity;
    private final MachineType machineType;

    public BlockFluidTank(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType, int tankCapacity)
    {
