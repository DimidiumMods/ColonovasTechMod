...
public class BlockSteamGenerator extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockSteamGenerator(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
