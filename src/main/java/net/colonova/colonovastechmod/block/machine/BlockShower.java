...
public class BlockShower extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockShower(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
