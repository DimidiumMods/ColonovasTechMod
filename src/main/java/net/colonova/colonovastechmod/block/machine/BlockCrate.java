...
public class BlockCrate extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockCrate(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
