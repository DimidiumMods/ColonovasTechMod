...
public class BlockCannon extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockCannon(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
