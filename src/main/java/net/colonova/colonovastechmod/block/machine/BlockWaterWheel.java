...
public class BlockWaterWheel extends BlockBase
{
    public BlockWaterWheel(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
