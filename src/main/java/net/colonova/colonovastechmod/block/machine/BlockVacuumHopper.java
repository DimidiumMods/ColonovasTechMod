...
public class BlockVacuumHopper extends BlockBase //implements EntityBlock, IMachineBlock
{
    public BlockVacuumHopper(Material material, float hardness, float resistance, SoundType soundType, MachineType machineType)
    {
